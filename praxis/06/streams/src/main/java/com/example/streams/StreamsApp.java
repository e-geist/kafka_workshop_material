...
public class StreamsApp {
    public static void main(String[] args) {
                ...
                source
                  .filter((key, value) -> {
                      try {  
                          ...
                          ?? // Bedingung für filter setzen: obj.get("value") enthält value, key Enthält key
                      } catch (Exception e) {
                  ...
                  .mapValues((key, value) -> {
                      try {
                          ...
                          ? // weitere Attribute in obj hinzufügen, basierend auf value v
        ...
        transformed.to(?, Produced.with(Serdes.String(), Serdes.String()));
